...
export default function Home(){return <main id="main">
 <section className="hero">
  ...
  <div className="hero-photo hero-truck"><Photo priority name="apex-work-truck-0094" alt={sharePhoto.alt}/></div>
 </section>
